...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("204.157.100.6".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("MG Suporte Remoto".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["204.157.100.6"];
pub const RS_PUB_KEY: &str = "f8gmfMeQ78E2XDh7Rz+09k3YfN9P3k9CYqofbDJ28yg=";
